...
class PessoaFisica(Pessoa):
    ...
    def __str__(self):
        return f"Olá, eu sou {self.nome}, gênero {self.genero}, trabalho como {self.profissao}, meu e-mail é {self.email}, meu telefone {self.telefone} e moro no endereço {self.endereco}."
