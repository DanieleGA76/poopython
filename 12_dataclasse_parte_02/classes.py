...
class PessoaFisica(Pessoa):
    ...
    def __str__(self):
        return f"Olá, meu nome é {self.nome}, trabalho como {self.profissao}, e meu CPF {self.cpf}, meu e-mail é {self.email}, meu telefone é {self.telefone} e meu endereço é {self.endereco}."
